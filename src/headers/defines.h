...
struct Config {
    ...
    String serverURL = "https://komakweb.duckdns.org/moodLampFirmware";
...
xTaskHandle Time_System_Task_Handle,lightTask_Handle,counterTask_Handle;
void onWsEvent(AsyncWebSocket* server, AsyncWebSocketClient* client, AwsEventType type, void* arg, uint8_t* data, size_t len);
//static const inline void sendSocket(String type, String msg);
static const inline void sendSocket(String type, String msg, uint32_t clientID = 0);
/* server things */
